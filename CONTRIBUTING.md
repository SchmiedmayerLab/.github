...
We use [GitHub Discussions](https://docs.github.com/en/discussions) at [https://github.com/orgs/SchmiedmayerLab/discussions](https://github.com/orgs/SchmiedmayerLab/discussions) for project discussions.
Please follow our [Code of Conduct](https://github.com/SchmiedmayerLab/.github/blob/main/CODE_OF_CONDUCT.md).
...
Please refer to our [Support Policy](https://github.com/SchmiedmayerLab/.github/blob/main/SUPPORT.md) for information about getting support.

## Security Policy

For security and vulnerability-related issues, please refer to our [Security Policy](https://github.com/SchmiedmayerLab/.github/blob/main/SECURITY.md).
